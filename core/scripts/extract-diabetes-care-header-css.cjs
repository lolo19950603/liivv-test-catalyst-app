...
.diabetes-care-section-header.header-section.header-pinned{position:fixed;left:0;right:0;top:0;z-index:100;width:100%;transform:translateZ(0);backface-visibility:hidden}
