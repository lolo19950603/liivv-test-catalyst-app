...
export const CHAPTERS: Chapter[] = [
  {
    ...
    heroImage: `${IMG}/chapter-everyday.jpg`,
    accent: '#8ea78b',
    categoriesIntro: {
    ...
    categories: [
      {
        ...
        image: `${IMG}/chapter-everyday.jpg`,
        items: [
  ...
  },
  {
    ...
    heroImage: `${IMG}/chapter-stoma.jpg`,
    accent: '#f3c7be',
    categoriesIntro: {
