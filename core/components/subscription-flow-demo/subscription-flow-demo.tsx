...
import './subscription-flow-demo.css';
...
export function SubscriptionFlowDemo({
  ...
  productBlurb = 'Recurring delivery on your schedule. Cancel anytime.',
  productPath = 'liivv.ca/product/everyday-essentials',
}: SubscriptionFlowDemoProps) {
    ...
    <div className="lh-sub-flow" data-step={active.id}>
      ...
      <div aria-hidden className="lh-sub-page" ref={pageRef}>
        <div className="lh-sub-page-chrome">
          ...
          <span />
          <span />
          <em>{step >= 4 ? 'liivv.ca/account/subscriptions' : productPath}</em>
        </div>
