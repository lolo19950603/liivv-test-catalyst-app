  ...
  return {
    ...
    wellness: {
      ...
      actionCenter: {
        ...
        orderHistoryHint: t('wellness.actionCenter.orderHistoryHint'),
        ...
        pharmacyCta: t('wellness.actionCenter.pharmacyCta'),
      },
      virtualCare: {
        title: t('wellness.virtualCare.title'),
        subtitle: t('wellness.virtualCare.subtitle'),
        consulting: t('wellness.virtualCare.consulting'),
        consultingHint: t('wellness.virtualCare.consultingHint'),
