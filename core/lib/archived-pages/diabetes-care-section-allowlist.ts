export const DIABETES_CARE_SECTION_OPTIONS = [
  ...
  { value: 'faq_VGRW8K', label: '10. FAQ (first)' },
  { value: 'floating_product_bundle_mYaf43', label: '11. Floating product bundle' },
  { value: 'rich_text_Ym7UeC', label: '12. Rich text (lower)' },
  { value: 'collection_list_n3fDJ6', label: '13. Collection list' },
  { value: 'faq_7B4B8U', label: 'FAQ (second)' },
  { value: 'image_with_text_overlay_7JgREg', label: '15. Image with text overlay' },
] as const;
