...
export const FEATURED_COLLECTIONS_ARCHIVE_STYLE =
  ...
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--scroll-row.fc-product-strip--peek-carousel{--fc-peek-card:min(72vw,17.5rem);display:flex!important;flex-flow:row nowrap!important;align-items:stretch!important;gap:clamp(0.75rem,2.5vw,1rem)!important;overflow-x:auto!important;overflow-y:visible!important;scroll-snap-type:x mandatory;scroll-padding-inline-start:max(1rem,env(safe-area-inset-left,0px));scroll-padding-inline-end:1rem;padding-inline-start:max(1rem,env(safe-area-inset-left,0px));padding-inline-end:1rem;touch-action:pan-x pinch-zoom;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain}` +
  diabetesCareMinimalProductScrollbarCss(FEATURED_COLLECTIONS_SECTION_ID, FC_PRODUCT_SCROLL_STRIP) +
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--peek-carousel>*{flex:0 0 var(--fc-peek-card)!important;width:var(--fc-peek-card)!important;max-width:var(--fc-peek-card)!important;min-width:0!important;scroll-snap-align:start!important;align-self:stretch!important}` +
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--peek-carousel .fc-product-slide{display:flex!important;flex-direction:column!important;align-items:stretch!important;width:100%!important;height:100%!important}` +
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--peek-carousel .fc-product-card{width:100%!important;max-width:100%!important;margin-inline:0!important;height:100%!important;flex:1 1 auto!important;display:flex!important;flex-direction:column!important;align-items:stretch!important}` +
  ...
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-card .product-card__content{background-color:rgb(var(--color-base-background));flex:1 1 auto}` +
  ...
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-card .fc-product-card-media img.fc-product-card-logo{object-fit:contain!important;padding:1.5rem}` +
