...
export const FEATURED_COLLECTIONS_ARCHIVE_STYLE =
  ...
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--scroll-row{display:grid;overflow-y:visible}` +
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--scroll-row::-webkit-scrollbar{display:none;height:0;width:0}}` +
  ...
  `#${FEATURED_COLLECTIONS_SECTION_ID} .fc-product-strip--scroll-row.fc-product-strip--peek-carousel::-webkit-scrollbar,#${FEATURED_COLLECTIONS_SECTION_ID} .slider--tablet .fc-product-strip--peek-carousel::-webkit-scrollbar{display:none;height:0;width:0}` +
