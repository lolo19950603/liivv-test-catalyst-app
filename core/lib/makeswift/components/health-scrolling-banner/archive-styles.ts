...
export function healthScrollingBannerLayoutCss(sectionDomId: string): string {
  ...
  return (
    ...
    `${root} .with-scrolling .image-with-text__content-col{position:relative;display:grid;min-height:650px}` +
    ...
    `${root} .with-scrolling .image-with-text__content-layer{grid-area:1/1;align-self:center;width:100%}` +
    ...
    `${root} .with-scrolling .health-scroll-banner-content-enter{width:100%;padding-block:var(--sp-8,2rem)}` +
    ...
    `${root} .with-scrolling .rich-text{padding-block-end:var(--sp-4,1rem)}` +
    `@media screen and (min-width:1024px){${root} .with-scrolling .image-with-text__image{min-height:650px;height:100%}${root} .with-scrolling .image-with-text__content-col{min-height:650px}}` +
