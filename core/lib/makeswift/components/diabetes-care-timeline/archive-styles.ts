...
export function timelineDotsCss(sectionDomId: string): string {
  ...
  return (
    ...
    `${root} .title-wrapper .indicators .button.button--secondary:not(:disabled){--border-opacity:1;--color-button-border:var(--timeline-step-active-channels,var(--color-button-border));--color-button-background:var(--timeline-step-active-channels,var(--color-button-background));color:var(--timeline-step-active-color,rgb(var(--color-button-background)))!important}` +
    `${root} .title-wrapper .indicators .button.button--secondary:not(:disabled) .btn-text{color:inherit!important}` +
    `${root} .title-wrapper .indicators .button.button--secondary:not(:disabled) svg{stroke:currentColor}` +
    `${root} .title-wrapper .indicators .button.button--secondary:disabled{--border-opacity:0.25;--color-button-border:var(--timeline-step-active-channels,var(--color-button-border));--color-button-background:var(--timeline-step-active-channels,var(--color-button-background));color:var(--timeline-step-inactive-color,rgb(var(--color-button-background)/.25))!important;opacity:1!important}` +
