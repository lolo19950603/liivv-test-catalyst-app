...
export type ProductSingularScrollingTextItem = {
  kind?: 'text' | 'image';
  text?: string;
  image?: unknown;
  imageAlt?: string;
...
export type ProductSingularScrollingTextProps = {
  className?: string;
...
export function ProductSingularScrollingText({
  ...
  const { sectionCss, sectionStyle } = buildSectionTheme({
    ...
    sectionCss: `${PRODUCT_SINGULAR_SCROLLING_TEXT_VARS}${productSingularScrollingTextMarqueeCss(resolvedSectionId, duration)}`,
    background,
  ...
  return (
    <div
      className={clsx(
        'product-singular-scrolling-text scrolling-text-section',
